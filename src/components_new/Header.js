...
background: "url(https://media.istockphoto.com/photos/tsaatan-boy-with-a-reindeer-in-a-landscape-of-northern-mongolia-picture-id1266475224)",
      ...
      <div className={classes.rectangle}>
        ...
        <div className={classes.preview}>
            ...
            <div className={classes.card2}>
                ...
                <div className={classes.text2} style={{position:"absolute",left:"89px", top:"25px" }}>Access Card </div>
                <div className={classes.text2} style={{position:"absolute",left:"118px",top:"40px"}}>Silver</div>
                <div className={classes.outlineIcon}>
                    <div style={{width:"16.55px",height:"13.72",position:"absolute"}}>
