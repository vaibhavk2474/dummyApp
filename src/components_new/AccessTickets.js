...
export default function AccessTickets() {
  ...
  return (
    <div className={classes.mainAccessTicket}>
      ...
      <div style={{ position: "absolute", left: "-108px" }}>
        <NftCard AccessTicketsInfo={AccessTicketsData.a}></NftCard>
      </div>
      <div style={{ position: "absolute", left: "250px" }}>
        <NftCard AccessTicketsInfo={AccessTicketsData.b}></NftCard>
      </div>
      <div style={{ position: "absolute", left: "595px" }}>
        <NftCard AccessTicketsInfo={AccessTicketsData.c}></NftCard>
      </div>
    </div>
  );
}
